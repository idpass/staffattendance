...
import np.com.naxa.staffattendance.utlils.DensityUtils;
...
public class LoginLoadingView extends View {
    ...
    private void initView() {
        ...
        mPaint.setStrokeWidth(DensityUtils.dp2px(getContext(), 3));
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        switch (mStatus) {
            ...
            case STATUS_LOGIN_SUCCESS:
                ...
                canvas.drawText(mLoginText, mSuccessTextX + getTextWidth(mSuccessText) + DensityUtils.dp2px(getContext(), 10), (mHeight + getTextHeight(mLoginText)) / 2, mPaint);
